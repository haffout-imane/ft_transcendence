...
export function renderLoginForm() {
    ...
    (_a = document.getElementById('show-register-link')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', (e) => {
        e.preventDefault();
        renderRegisterForm();
    });
    setupLoginForm();
...
export function renderRegisterForm() {
    ...
    (_a = document.getElementById('show-login-link')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', (e) => {
        e.preventDefault();
        renderLoginForm();
    });
    setupRegisterForm();
