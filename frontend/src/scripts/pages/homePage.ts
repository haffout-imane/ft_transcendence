...
export function renderHomePage() {
        ...
        <div class="carousel-wrapper">
          ...
          <div class="carousel-container">
            <div class="carousel-track">
              <a href="/offline" data-link><img src="/assets/game/1.png" alt="offline" /></a>
              <a href="/onlineGame" data-link><img src="/assets/game/2.png" alt="online" /></a>
              <a href="/teamUp" data-link><img src="/assets/game/3.png" alt="teamUp" /></a>
              <a href="/aiBot" data-link><img src="/assets/game/4.png" alt="aiBot" /></a>
  ...
  const nextBtn = document.querySelector(".next-link") as HTMLAnchorElement;
  const prevBtn = document.querySelector(".previous-link") as HTMLAnchorElement;
